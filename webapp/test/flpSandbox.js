		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comsapassessmentui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapassessmentui5-display": {
								"semanticObject": "comsapassessmentui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.assessmentui5",
									"url": sap.ui.require.toUrl("com/sap/assessmentui5")
								}
							}
						}
					}
